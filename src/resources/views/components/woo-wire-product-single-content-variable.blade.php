@props(['product'])
<div class="divide-y divide-gray-200" x-data="variants">
    ...
    @if ($product['description'])
        <div class="flex flex-col py-3">
            ...
            @foreach ($product['childProducts'] as $childProduct)
                <p x-show="$wire.currentProduct.selectedVariant == {{ $childProduct['id'] }}" class="text-gray-600">{!! $childProduct['description'] !!}</p>
            @endforeach
        </div>
    @endif
    <script>
